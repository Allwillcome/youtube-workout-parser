...
const translations: Record<Language, Record<string, string>> = {
  en: {
    appName: 'FitParser',
    tagline: 'YouTube / Bilibili / Douyin → Executable Workout Plan',
    heroBadge: 'Multi-Platform Video Biomechanical Extraction Engine',
    heroTitle: 'Transform Fitness Videos Into',
    heroTitleGradient: 'Executable Workout Plans',
    heroDesc: 'Supports YouTube, Bilibili & Douyin videos. Extract strict exercises, sets, reps and form cues directly.',
    urlLabel: 'Video Link (YouTube / Bilibili / Douyin)',
    urlPlaceholder: 'Paste YouTube / Bilibili (BV...) / Douyin video link...',
    parseBtn: 'Parse Video',
    parsingBtn: 'Parsing Video Transcript...',
    ...
    step1: 'Step 1/4: Fetching video metadata & captions...',
  ...
  zh: {
    appName: 'FitParser',
    tagline: 'YouTube / B站 / 抖音 视频 → 可执行训练计划',
    heroBadge: '全网多平台 · 生物力学动作提取引擎',
    heroTitle: '把全网健身视频转换成',
    heroTitleGradient: '可执行的训练计划',
    heroDesc: '支持 YouTube、哔哩哔哩 (B站) 与 抖音视频。严谨提取动作、组数次数与动作姿势要点。',
    urlLabel: '视频链接 (支持 YouTube / B站 / 抖音)',
    urlPlaceholder: '粘贴 YouTube / B站 (BV...) / 抖音 视频链接...',
    parseBtn: '解析视频',
    parsingBtn: '正在提取视频字幕与结构...',
    advancedOptions: '高级 API 与自定义字幕选项',
    apiKeyLabel: 'OpenAI / DeepSeek API Key (可选)',
    customSubLabel: '自定义粘贴视频字幕文本 (可选)',
    step1: '步骤 1/4: 抓取视频元数据与字幕...',

...
export function ShareView({ plan }: ShareViewProps) {
  ...
  return (
    <div className="w-full max-w-[1200px] mx-auto p-4 lg:p-8 space-y-8">
      {/* Back Button */}
      <Link 
        href="/"
      ...
      {/* Share Card Header */}
      <div className="relative overflow-hidden rounded-3xl bg-slate-900/90 border border-slate-800 p-6 lg:p-10 space-y-6 shadow-2xl">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
          ...
          <div className="flex flex-wrap items-center gap-3 shrink-0">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2.5 bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-semibold rounded-xl transition-all active:scale-95 shadow-lg shadow-indigo-600/25"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2.5 bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-semibold rounded-xl transition-all border border-slate-700"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-400 hover:to-orange-500 text-slate-950 font-bold text-xs rounded-xl transition-all shadow-lg shadow-orange-500/20"
            >
        ...
        <div className="pt-6 border-t border-slate-800/80 flex flex-col sm:flex-row sm:items-center justify-between gap-4 text-xs text-slate-400">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-slate-400 text-[11px]">{plan.source.channel_name}</p>
            </div>
          </div>
          ...
          <a 
            ...
            className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-slate-950 hover:bg-slate-900 border border-slate-800 rounded-lg text-indigo-400 font-medium transition-colors self-start sm:self-auto"
          >
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {plan.exercises.map((ex, index) => {
            ...
            return (
              <div key={ex.id || index} className="bg-slate-900/80 border border-slate-800/80 rounded-2xl p-5 space-y-4 overflow-hidden">
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-1 flex-1">
                    <div className="flex items-center gap-2">
                      <span className="w-5 h-5 rounded-md bg-indigo-600/20 text-indigo-400 font-bold text-xs flex items-center justify-center">
                        {index + 1}
                      </span>
                ...
                {ex.coaching_cues && ex.coaching_cues.length > 0 && (
                  <div className="bg-indigo-950/30 border border-indigo-500/20 rounded-xl p-3 space-y-1.5">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 lg:p-8 max-w-md w-full space-y-5 shadow-2xl">
            ...
            <div className="flex justify-end gap-3 pt-2">
              ...
              <button
                ...
                className="px-4 py-2 bg-gradient-to-r from-amber-500 to-orange-600 text-slate-950 font-bold text-xs rounded-xl hover:opacity-90"
              >
